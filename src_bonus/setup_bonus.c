...
/*
** Version bonus de ft_setup.
** Comportement identique à la version mandatory.
** Voir src/setup.c pour le détail complet des étapes.
*/
void ft_setup_bonus(t_data *data, const char *filename)
{
	...
	/* EI_NIDENT = 16 octets : minimum pour lire le magic ELF et le byte EI_CLASS */
...
/*
** Version bonus de ft_check_file.
** Comportement identique à la version mandatory.
** Voir src/setup.c pour le détail complet.
*/
void ft_check_file_bonus(t_data *data, const char *filename)
{
	...
	/* EI_CLASS détermine si le binaire est 32 ou 64 bits */
	if (index[EI_CLASS] == 1)
	{
